export const selfCheck = () => console.log(
  `
  Score 190 / 190
  ...
  2. "Garage" view:
    ...
    - (+10) User should be able to select any color from an RGB-Palete and see the picture of the car colored with the color selected and car's name.
